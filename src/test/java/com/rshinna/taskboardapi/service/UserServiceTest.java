...
public class UserServiceTest {
    ...
    void shouldCreateUserSuccessfully() {
        ...
        CreateUserRequest request = new CreateUserRequest("Rodrigo", "rodrigo@email.com", "123456", Role.USER);

        User savedUser = User.builder().id(UUID.randomUUID()).name("Rodrigo").email("rodrigo@email.com").password("senha-criptografada").role(Role.USER).build();
    ...
    void shouldThrowExceptionWhenEmailAlreadyExists() {
        ...
        User user = User.builder().id(UUID.randomUUID()).name("Rodrigo").email("rodrigo@email.com").password("senha-criptografada").role(Role.USER).build();
    ...
    void shouldPromoteUserSuccessfully() {
        ...
        User user = User.builder().id(userId).name("Rodrigo").email("rodrigo@email.com").password("senha-criptografada").role(Role.USER).build();
    ...
    void shouldThrowExceptionWhenUserNotFound() {
        ...
        ResourceNotFoundException exception = assertThrows(ResourceNotFoundException.class, () -> userService.promoteUser(userId));
